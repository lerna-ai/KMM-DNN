 ...
 */
internal class IndRNNLayer<InputNDArrayType : NDArray<InputNDArrayType>>(
   ...
   */
  override val forwardHelper = IndRNNForwardHelper(layer = this)

  /**
   * The helper which executes the backward
   */
  override val backwardHelper = IndRNNBackwardHelper(layer = this)
