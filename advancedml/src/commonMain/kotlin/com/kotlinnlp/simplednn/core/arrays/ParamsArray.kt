...
class ParamsArray(
  @Contextual val values: DenseNDArray,
  ...
  inline fun <reified StructureType: UpdaterSupportStructure>getOrSetSupportStructure(): StructureType {
    ...
    if (this.updaterSupportStructure == null) {
      when(StructureType::class.simpleName){
        "LearningRateStructure" -> this.updaterSupportStructure = LearningRateStructure(this.values.shape)
        "ADAMStructure" -> this.updaterSupportStructure = ADAMStructure(this.values.shape)
        "AdaGradStructure" -> this.updaterSupportStructure = AdaGradStructure(this.values.shape)
        "MomentumStructure" -> this.updaterSupportStructure = MomentumStructure(this.values.shape)
        "NesterovMomentumStructure" -> this.updaterSupportStructure = NesterovMomentumStructure(this.values.shape)
        "RMSPropStructure" -> this.updaterSupportStructure = RMSPropStructure(this.values.shape)
      }
