...
internal object IndRNNLayerStructureUtils {
  ...
  fun buildParams() = IndRNNLayerParameters(inputSize = 4, outputSize = 5).apply {
    ...
    recurrentWeights.values.assignValues(DenseNDArrayFactory.arrayOf(floatArrayOf(0.0f, -0.7f, -0.9f, 0.0f, -0.6f)))
  }

  /**
   *
   */
  fun getOutputErrors() = DenseNDArrayFactory.arrayOf(floatArrayOf(0.57f, 0.75f, -0.15f, 1.64f, 0.45f))
}
