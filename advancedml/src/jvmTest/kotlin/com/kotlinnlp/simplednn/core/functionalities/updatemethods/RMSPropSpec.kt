  ...
  describe("the RMSProp update method") {
    ...
    context("update with dense errors") {
      ...
      context("update") {
        ...
        val updateHelper = RMSPropMethod(learningRate = 0.001f, epsilon = 1e-06f, decay = 0.9f)
        ...
        it("should match the expected updated array") {
          assertTrue {
            updatableArray.values.equals(
              DenseNDArrayFactory.arrayOf(floatArrayOf(0.399091f, 0.398905f, 0.499502f, 0.996838f, 0.799765f)),
              tolerance = 1.0e-6f)
          }
        }
      }
    ...
    context("update with sparse errors") {
      ...
      context("update") {
        ...
        it("should match the expected updated array") {
          assertTrue {
            updatableArray.values.equals(
              DenseNDArrayFactory.arrayOf(floatArrayOf(0.4f, 0.39890545f, 0.5f, 1.0f, 0.79930994f)),
              tolerance = 1.0e-8f)
          }
        }
      }
