...
internal object SquaredDistanceLayerUtils {
  ...
  fun buildLayer(): SquaredDistanceLayer<DenseNDArray> = SquaredDistanceLayer(
    inputArray = AugmentedArray(values = DenseNDArrayFactory.arrayOf(floatArrayOf(0.3f, 0.5f, -0.4f))),
  ...
  private fun getParams35() = SquaredDistanceLayerParameters(inputSize = 3, rank = 5).apply {
    wB.values.assignValues(
      DenseNDArrayFactory.arrayOf(listOf(
        floatArrayOf(0.4f, 0.6f, -0.5f),
        floatArrayOf(-0.5f, 0.4f, 0.2f),
        floatArrayOf(0.5f, 0.4f, 0.1f),
        floatArrayOf(0.5f, 0.2f, -0.2f),
        floatArrayOf(-0.3f, 0.4f, 0.4f)
      )))
  }
