...
class AugmentedArraySpec : Spek({
  ...
  describe("an AugmentedArray") {
    ...
    val errors = DenseNDArrayFactory.arrayOf(floatArrayOf(0.4f, 0.8f, 0.1f, 0.8f, 0.4f, 0.1f, 0.2f, 0.9f, 0.2f))
    val arrayWrongSize = DenseNDArrayFactory.arrayOf(floatArrayOf(0.0f, 0.1f, 0.01f, -0.1f))
    ...
    context("errors") {
      ...
      context("after assignment, with values initialized") {
        ...
        it("should have the expected assigned errors") {
          assertTrue { augmentedArray.errors.equals(errors, tolerance = 1.0e-08f) }
        }
      }
    ...
    context("relevance") {
      ...
      context("after assignment, with values initialized") {
        ...
        it("should have the expected assigned relevance") {
          assertTrue { arrayRelevance.equals(relevance, tolerance = 1.0e-08f) }
        }
      }
    ...
    context("recurrent relevance") {
      ...
      context("after assignment, with values initialized") {
        ...
        it("should have the expected assigned recurrent relevance") {
          assertTrue { arrayRecRelevance.equals(recurrentRelevance, tolerance = 1.0e-08f) }
        }
      }
    ...
    context("cloning") {
      ...
      context("values initialized") {
        ...
        it("should have the expected errors") {
          assertTrue { augmentedArray.errors.equals(cloneArray.errors, tolerance = 1.0e-08f) }
        }

        it("should have the expected relevance") {
          val cloneRelevance = cloneArray.relevance
          assertTrue { arrayRelevance.equals(cloneRelevance, tolerance = 1.0e-08f) }
        }

        it("should have the expected recurrent relevance") {
          val cloneRecRelevance = cloneArray.recurrentRelevance as DenseNDArray
          assertTrue { arrayRecRelevance.equals(cloneRecRelevance, tolerance = 1.0e-08f) }
        }
      }
    }
  }
