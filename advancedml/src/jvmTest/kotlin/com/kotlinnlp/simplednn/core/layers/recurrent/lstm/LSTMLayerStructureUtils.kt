...
internal object LSTMLayerStructureUtils {
  ...
  fun buildParams() = LSTMLayerParameters(inputSize = 4, outputSize = 5).apply {
    ...
    candidate.weights.values.assignValues(
      DenseNDArrayFactory.arrayOf(listOf(
        floatArrayOf(0.2f, 0.6f, 0.0f, 0.1f),
        floatArrayOf(0.1f, -0.3f, -0.8f, -0.5f),
        floatArrayOf(-0.1f, 0.0f, 0.4f, -0.4f),
        floatArrayOf(-0.8f, -0.3f, -0.7f, 0.3f),
        floatArrayOf(-0.4f, 0.9f, 0.8f, -0.3f)
      )))

    inputGate.biases.values.assignValues(DenseNDArrayFactory.arrayOf(floatArrayOf(0.4f, 0.0f, -0.3f, 0.8f, -0.4f)))
    outputGate.biases.values.assignValues(DenseNDArrayFactory.arrayOf(floatArrayOf(0.9f, 0.2f, -0.9f, 0.2f, -0.9f)))
    forgetGate.biases.values.assignValues(DenseNDArrayFactory.arrayOf(floatArrayOf(0.5f, -0.5f, 1.0f, 0.4f, 0.9f)))
    candidate.biases.values.assignValues(DenseNDArrayFactory.arrayOf(floatArrayOf(0.2f, -0.9f, -0.9f, 0.5f, 0.1f)))
    ...
    candidate.recurrentWeights.values.assignValues(
      DenseNDArrayFactory.arrayOf(listOf(
        floatArrayOf(-0.3f, 0.3f, -0.1f, 0.6f, -0.7f),
        floatArrayOf(-0.2f, -0.8f, -0.6f, -0.5f, -0.4f),
        floatArrayOf(-0.4f, 0.8f, -0.5f, -0.1f, 0.9f),
        floatArrayOf(0.3f, 0.7f, 0.3f, 0.0f, -0.4f),
        floatArrayOf(-0.3f, 0.3f, -0.7f, 0.0f, 0.7f)
      )))
  }
