      ...
      it("should match the expected outputArray") {
        assertTrue {
          layer.outputArray.values.equals(
              DenseNDArrayFactory.arrayOf(floatArrayOf(0.085901f)),
              tolerance = 1.0e-05f)
        }
      }
    }
      ...
      it("should match the expected errors of the inputArray1") {
        assertTrue {
          layer.inputArrays[0].errors.equals(
              DenseNDArrayFactory.arrayOf(floatArrayOf(0.20470f, -0.16376f, 0.29455f, -0.31159f)),
              tolerance = 1.0e-05f)
        }
      }
      ...
      it("should match the expected errors of the inputArray2") {
        assertTrue {
          layer.inputArrays[1].errors.equals(
              DenseNDArrayFactory.arrayOf(floatArrayOf(-0.31900f, -0.34126f, 0.25436f, 0.22256f)),
              tolerance = 1.0e-05f)
        }
      }
    }
