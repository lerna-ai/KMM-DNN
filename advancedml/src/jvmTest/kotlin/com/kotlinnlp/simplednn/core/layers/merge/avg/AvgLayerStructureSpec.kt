...
package com.kotlinnlp.simplednn.core.layers.merge.avg
      ...
      it("should match the expected outputArray") {
        assertTrue {
          layer.outputArray.values.equals(
            DenseNDArrayFactory.arrayOf(floatArrayOf(-0.275f, 0.075f, 0.025f)),
            tolerance = 1.0e-05f)
        }
      }
    }
      ...
      it("should match the expected errors of the inputArray at index 0") {
        assertTrue {
          layer.inputArrays[0].errors.equals(
            DenseNDArrayFactory.arrayOf(floatArrayOf(-0.25f, -0.05f, 0.1f)),
            tolerance = 1.0e-05f)
        }
      }
