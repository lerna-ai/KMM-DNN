...
package com.kotlinnlp.simplednn.deeplearning.attention

import com.kotlinnlp.simplednn.deeplearning.attention.attentionnetwork.AttentionNetwork
import com.kotlinnlp.simplednn.simplemath.ndarray.dense.DenseNDArray
import com.kotlinnlp.simplednn.simplemath.ndarray.dense.DenseNDArrayFactory
import com.kotlinnlp.simplednn.core.attention.AttentionLayerUtils
      ...
      it("should match the expected errors of the first input") {
        assertTrue {
          inputErrors[0].equals(
            DenseNDArrayFactory.arrayOf(floatArrayOf(-0.076383f, 0.148207f, 0.021613f, -0.175261f)),
            tolerance = 1.0e-06f)
        }
      }
      ...
      it("should match the expected errors of the second input") {
        assertTrue {
          inputErrors[1].equals(
            DenseNDArrayFactory.arrayOf(floatArrayOf(-0.073648f, 0.172493f, 0.032455f, -0.179081f)),
            tolerance = 1.0e-06f)
        }
      }
      ...
      it("should match the expected errors of the third input") {
        assertTrue {
          inputErrors[2].equals(
            DenseNDArrayFactory.arrayOf(floatArrayOf(-0.048449f, 0.181651f, 0.046974f, -0.147318f)),
            tolerance = 1.0e-06f)
        }
      }
    }
